        ...
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-slate-100 dark:border-slate-700/50 hover:shadow-xl transition-shadow duration-300">
            <h2 className="text-xl font-bold text-slate-800 dark:text-white mb-4 flex items-center gap-3">
              <span className="w-8 h-8 bg-sky-100 dark:bg-sky-900/30 rounded-lg flex items-center justify-center text-sky-500 font-bold text-sm">
                1
              </span>
              Services
            </h2>
          ...
          <div className="bg-white dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-slate-100 dark:border-slate-700/50 hover:shadow-xl transition-shadow duration-300">
            ...
            <ul className="space-y-3">
              {[
                "Cancellation and refund policies vary by airline, hotel, embassy, or service provider. A 15% service fee will be deducted by our travel agency in addition to any airline deductions.",
          ...
          <div className="bg-white dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-slate-100 dark:border-slate-700/50 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              Customers are responsible for ensuring that their passport, visa,
              vaccination certificates, and other required travel documents are
              valid before travel.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-slate-100 dark:border-slate-700/50 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              Customers must provide accurate information during booking. We are
              not responsible for delays or losses caused by incorrect
          ...
          <div className="bg-white dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-slate-100 dark:border-slate-700/50 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              We act as an intermediary between customers and airlines, hotels,
              transport providers, and embassies. We are not responsible for
              delays, cancellations, schedule changes, baggage loss, natural
              disasters, government restrictions, or events beyond our control.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-slate-100 dark:border-slate-700/50 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
              For any questions regarding our services or these Terms &
              Conditions, please contact us through our official phone number,
