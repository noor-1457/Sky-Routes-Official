      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-slateText dark:text-slate-400 mt-3 text-xs leading-relaxed">
              ...
              visa-ready travel files across the Gulf and beyond—with honest
              pricing and a real human on WhatsApp whenever you need us.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center p-4">
              ...
              <p className="text-[10px] text-slateText dark:text-slate-400">
